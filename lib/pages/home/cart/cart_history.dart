  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          Container(
            height: Dimenisions.height10 * 10,
                                                  ...
                                                  ? Container(
                                                      ...
                                                      decoration: BoxDecoration(
                                                          borderRadius: BorderRadius
                                                              .circular(Dimenisions
                                                                      .radius15 /
                                                                  2),
                                                          image: DecorationImage(
                                                              fit: BoxFit.cover,
                                                              image: NetworkImage(AppContans
                                                                      .BASE_URL +
                                                                  AppContans
                                                                      .UPLOADS_URL +
                                                                  getCartHistoryList[
